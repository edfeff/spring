package core.chapter05.s5.around;
...
public class AroundAdviceExample {
    ...
    private void before(ProceedingJoinPoint joinPoint) {
        ...
        System.out.println("类型 " + signature.getDeclaringType());//class core.chapter05.s5.S05User
        System.out.println("类型 " + signature.getDeclaringTypeName());//core.chapter05.s5.S05User
        System.out.println("方法修饰符 " + signature.getModifiers());//1
        System.out.println("方法名 " + signature.getName());//setName
        System.out.println("全签名 " + signature.toString());//void core.chapter05.s5.S05User.setName(String)
