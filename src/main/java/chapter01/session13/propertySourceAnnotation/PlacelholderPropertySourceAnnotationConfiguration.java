package chapter01.session13.propertySourceAnnotation;
 ...
 */
@Configuration
@PropertySource("classpath:${my.base.package:chapter01/session13/propertySourceAnnotation}/app.properties")
